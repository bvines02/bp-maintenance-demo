...
export const getH1_1 = (platforms?: string) => api.get("/analysis/hypothesis/h1-1", { params: p(platforms) }).then(r => r.data);
export const getH1_2 = (platforms?: string) => api.get("/analysis/hypothesis/h1-2", { params: p(platforms) }).then(r => r.data);
export const getH1_3 = (platforms?: string) => api.get("/analysis/hypothesis/h1-3", { params: p(platforms) }).then(r => r.data);
